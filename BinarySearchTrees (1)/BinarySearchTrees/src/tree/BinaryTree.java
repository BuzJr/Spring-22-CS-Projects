...
public class BinaryTree<T> {
	...
	private String getInOrder(TreeNode<T> curNode) {
		...
		if(curNode==null)
			return "";
		s += getInOrder(curNode.left);
		s = s+curNode.data.toString()+" ";
		s += getInOrder(curNode.right);
		return s;
	}
	...
	private String getPreOrder(TreeNode<T> curNode) {
		...
		if(curNode==null)
			return "";
		s = s+curNode.data.toString()+" ";
		s += getPreOrder(curNode.left);
		s += getPreOrder(curNode.right);
		return s;
	}
	...
	private String getPostOrder(TreeNode<T> curNode) {
		...
		if(curNode==null)
			return "";
		s += getPostOrder(curNode.left);
		s += getPostOrder(curNode.right);
		s = s+curNode.data.toString()+" ";
		return s;
	}
